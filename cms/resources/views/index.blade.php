...
<html class="scroll-smooth" lang="es">
  ...
  >
    ...
    @include('partials._nav', ['active' => 'home'])
    ...
    <main id="top">
      ...
      >
        <div
          ...
          style="background: linear-gradient(105deg, rgba(13,8,32,0.94) 0%, rgba(13,8,32,0.78) 55%, rgba(13,8,32,0.42) 100%);"
        ></div>
        <div class="relative mx-auto w-full max-w-7xl">
          ...
          >
            Liderando la evolución del CX en LATAM desde 1990
          </span>
          <h1
          ...
          <div class="mt-14 grid grid-cols-2 gap-4 sm:flex sm:flex-wrap">
            <div class="glass rounded-2xl border border-white/10 px-5 py-4">
              <p class="text-3xl font-extrabold text-white">35+</p>
              <p
            ...
            <div class="glass rounded-2xl border border-white/10 px-5 py-4">
              <p class="text-3xl font-extrabold text-white">ISO 9001</p>
              <p
                class="mt-1 text-xs font-semibold uppercase tracking-[0.2em] text-muted"
              >
                Certificados
    ...
    <a href="https://wa.me/5491176602200" target="_blank" rel="noopener" class="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-lg transition-all hover:scale-110"
       title="Contactá por WhatsApp">
      <svg class="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M20.52 3.48A11.8 11.8 0 0 0 12.06 0C5.57 0 .29 5.28.29 11.77c0 2.07.54 4.09 1.57 5.87L0 24l6.54-1.71a11.7 11.7 0 0 0 5.52 1.41h.01c6.49 0 11.77-5.28 11.77-11.77 0-3.14-1.22-6.09-3.32-8.45Zm-8.46 18.23h-.01a9.84 9.84 0 0 1-5.01-1.37l-.36-.21-3.88 1.01 1.04-3.79-.23-.39a9.8 9.8 0 0 1-1.5-5.19c0-5.43 4.42-9.85 9.86-9.85 2.63 0 5.09 1.02 6.95 2.89a9.79 9.79 0 0 1 2.88 6.96c0 5.43-4.42 9.85-9.85 9.85Z"/>
      </svg>
    </a>
  </body>
</html>
