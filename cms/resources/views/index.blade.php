    ...
    <main id="top">
      ...
      <section class="px-6 py-16">
        <div class="mx-auto max-w-6xl">
          <div class="rounded-2xl bg-gradient-to-r from-brand/10 to-cyan/10 border border-brand/20 p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8">
            <div class="flex-1">
            ...
            <div class="flex-shrink-0">
              <a href="/docs/brief-frost-sullivan.pdf" download class="inline-flex items-center gap-3 px-8 py-4 bg-brand text-white font-semibold rounded-full hover:bg-brandSoft transition-all hover:scale-105 shadow-lg whitespace-nowrap">
